...
library(ggplot2)
#load data 
AustralianWines <- read_csv("AustralianWines/AustralianWines.csv")
head(AustralianWines)
length(AustralianWines$Fortified)
#change data format
AustralianWines$Month=paste(ymd(AustralianWines$Month))
#define ts object
Fortified.ts<-ts(AustralianWines$Fortified,c(2001,1),frequency=12)
